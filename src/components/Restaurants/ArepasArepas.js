import {
  ...
  export default function ArepasArepas() {
    return (
      <>
        <div>
          <h1 className="text-dark text-center fw-bold py-2">
            <strong>AREPAS Y AREPAS PARRILA </strong>
          </h1>
          <h3 className="text-dark text-center fw-bold ">
            <strong>Calle 29 Con Transv 15 Barrio </strong>
          </h3>
        </div>
        ...
        <div>
          <h2 className="text-dark text-center fw-bold py-2">
            ...
            <a className="" href="tel:+57 3146705133">
              {" 314 670 5133 "}
            </a>
            o escribenos al
            <a
