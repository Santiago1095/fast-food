...
import imgArrozChino1 from "../../assets/imgArrozChino1.png";
import imgArrozChino2 from "../../assets/imgArrozChino2.png";
...
export default function ArrozChinoYopalE() {
  return (
    <>
      <div>
        <h1 className="text-dark text-center fw-bold py-2">
          <strong>ARROZ CHINO YOPAL EXPRESS</strong>
        </h1>
        <h3 className="text-dark text-center fw-bold ">
          <strong>Calle 19 Nº 22-21 Barrio El Gavan</strong>
        </h3>
      </div>
      ...
      <div>
        <h2 className="text-dark text-center fw-bold py-2">
          ...
          <a className="" href="tel:+57 3144586708">
            {" 314 458 6708 "}
          </a>
          o escribenos al
          <a
        ...
        <h2 className="text-dark text-center fw-bold py-2">
          ​​Horario de atención de lunes a domingo de 10:00 - 15:00
        </h2>
                  ...
                  <Col md="6">
                    <CardBody>
                      ...
                      <CardSubtitle
                        ...
                        tag="h6"
                      >
                        Arroz, carne, tomate, queso, salsas, acompañado con
                      </CardSubtitle>
                  ...
                  <Col md="6">
                    <CardBody>
                      ...
                      <CardSubtitle
                        ...
                        tag="h6"
                      >
                        Pasta, lechuga, tomate, queso, salsas, acompañado con
                        papas a la francesa.
                      </CardSubtitle>
                      <CardText className="text-end text-danger fw-bold">
                        {" "}
              ...
              <Card>
                <Row>
                  ...
                  <Col md="6">
                    <CardBody>
                      <CardTitle tag="h5" className="text-start fw-bold py-2">
                        Mixto Shopsuey Arroz
                      </CardTitle>
                      <CardSubtitle
                        className="mb-1 text-muted fw-bold"
                        tag="h6"
                      >
                        Salchicha americana, tomate, queso, salsas, acompañado
                        con papas a la francesa.
                      </CardSubtitle>
                      <CardText className="text-end text-danger fw-bold">
                        {" "}
              ...
              <Card>
                <Row>
                  ...
                  <Col md="6">
                    <CardBody>
                      <CardTitle tag="h5" className="text-start fw-bold py-2">
                        Arroz Chino Mas 1 Presa De Pollo
                      </CardTitle>
                      <CardSubtitle
                        className="mb-1 text-muted fw-bold"
                        tag="h6"
              ...
              <Card>
                <Row>
                  ...
                  <Col md="6">
                    <CardBody>
                      <CardTitle tag="h5" className="text-start fw-bold py-2">
                        Arroz Chino Mas Costilla Cerdo
                      </CardTitle>
                      <CardSubtitle
                        className="mb-1 text-muted fw-bold"
                        tag="h6"
              ...
              <Card>
                <Row>
                  ...
                  <Col md="6">
                    <CardBody>
                      <CardTitle tag="h5" className="text-start fw-bold py-2">
                        Arroz Chino Mas 2 Presa De Pollo
                      </CardTitle>
                      <CardSubtitle
                        className="mb-1 text-muted fw-bold"
                        tag="h6"
                      >
                        Nuggest de pollo, lechuga, tomate, queso, salsas,
              ...
              <Card>
                <Row>
                  ...
                  <Col md="6">
                    <CardBody>
                      <CardTitle tag="h5" className="text-start fw-bold py-2">
                        Arroz Chino Mas 3 Presa De Pollo
                      </CardTitle>
                      <CardSubtitle
                        className="mb-1 text-muted fw-bold"
                        tag="h6"
              ...
              <Card>
                <Row>
                  ...
                  <Col md="6">
                    <CardBody>
                      <CardTitle tag="h5" className="text-start fw-bold py-2">
                        Arroz Chino Mas 4 Presa De Pollo
                      </CardTitle>
                      <CardSubtitle
                        className="mb-1 text-muted fw-bold"
                        tag="h6"
              ...
              <Card>
                <Row>
                  ...
                  <Col md="6">
                    <CardBody>
                      <CardTitle tag="h5" className="text-start fw-bold py-2">
                        Arroz Chino Mas 5 Presa De Pollo
                      </CardTitle>
                      <CardSubtitle
                        className="mb-1 text-muted fw-bold"
                        tag="h6"
              ...
              <Card>
                <Row>
                  ...
                  <Col md="6">
                    <CardBody>
                      <CardTitle tag="h5" className="text-start fw-bold py-2">
                        Arroz Chino Mas 8 Presa De Pollo
                      </CardTitle>
                      <CardSubtitle
                        className="mb-1 text-muted fw-bold"
                        tag="h6"
              ...
              <Card>
                <Row>
                  ...
                  <Col md="6">
                    <CardBody>
                      <CardTitle tag="h5" className="text-start fw-bold py-2">
                        Arroz Chino Mas 10 Presa De Pollo
                      </CardTitle>
                      <CardSubtitle
                        className="mb-1 text-muted fw-bold"
                        tag="h6"
