import {
  ...
  export default function HamburguesasElCalvo() {
    return (
      <>
        <div>
          <h1 className="text-dark text-center fw-bold py-2">
            <strong>HAMBURGUESAS EL CALVO</strong>
          </h1>
          <h3 className="text-dark text-center fw-bold ">
            <strong>Carrera 14 con 29 Esquina  Barrio ...</strong>
          </h3>
        </div>
        ...
        <div>
          <h2 className="text-dark text-center fw-bold py-2">
            ...
            <a className="" href="tel:+57 3106599413">
              {" 310 659 9413"}
            </a>
            o escribenos al
            <a
